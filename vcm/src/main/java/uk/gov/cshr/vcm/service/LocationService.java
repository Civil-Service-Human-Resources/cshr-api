...
/**
 * This service is responsible for calling an external location lookup service
 * to transform a place into a coordinates representing latitude and longitude.
 */
@Service
public class LocationService {
    ...
    /**
     * This method calls an external service to map the given location to
     * coordinates representing a single latitude and longitude.
     *
     * It is possible that no results are found.
     *
     * @param location the place whose latitude and longitude coordinates are
     * required
     * @return Coordinates the corresponding latitude and longitude of the given
     * location
     */
